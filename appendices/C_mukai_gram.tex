...
\]
The even integral lattice carries the K\"unneth pairing
\(\widetilde H(X,\Z)=\widetilde H(S,\Z)\otimes H^{\mathrm{even}}(E,\Z)\),
of rank $48$ and signature $(24,24)$ — the K\"unneth tensor of the
$(4,20)$-Mukai pairing on $\widetilde H(S,\Z)$ with the
$(1,1)$-hyperbolic pairing on the rank-2 lattice
\(U_E=H^{\mathrm{even}}(E,\Z)=H^0(E,\Z)\oplus H^2(E,\Z)\).  The
hyperbolic-plane decomposition gives
\(\widetilde H(S,\Z)\otimes U_E\simeq
U^{\oplus4}\oplus E_8(-1)^{\oplus2}\) tensored with \(U_E\); the odd
