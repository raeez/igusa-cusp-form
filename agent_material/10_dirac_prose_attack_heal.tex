...
\textbf{Bad sentences.}
\begin{quote}\small
\(\backslash\)label\{thm:bracket-level-square-root\}
...
\textbf{Replacement.}
\begin{quote}\small
\(\backslash\)label\{thm:denominator-algebra-square-root\}
...
\ref{thm:bracket-level-square-root}.
\end{quote}
\textbf{Attack.}
...
\ref{thm:denominator-algebra-square-root}.
\end{quote}
