...
C_{\mathrm{OP}}=-4096.
$$
For the Hilbert-scheme DT branch in the quotient-by-\(E\),
Behrend-weighted normalization, the later OP--DT integration pass fixes
the equality with the OP branch by the route
Oberdieck reduced DT/PT, Oberdieck--Pandharipande GW/PT for primitive
classes, and Oberdieck--Pixton's primitive Igusa theorem.  Thus the
honest statement in the current manuscript is the theorem
$$
