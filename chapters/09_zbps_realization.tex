...
\]
read off the \(X\)- and \(X^2\)-coefficients of the spin Euler factor
below, with \(\lambda_g(p)\) the normalized \(p\)-th Hecke eigenvalue of
...
\(\lambda_1^{\mathrm{SK}}(3)=-4284+3^8+3^9=21960\); the
Ramanujan bound is violated (\(\lvert\lambda_1^{\mathrm{SK}}(p)\rvert
\sim p^9\), not \(p^{9/2}\)), the signature of the
...
The residual is Vol~II's Construction Problem~2
\cite{ChiralBarCobarVolII}, the gravity-line operator algebra
acting on the boundary. It is not claimed here; its existence and
the construction of its witnessing morphism are open.
