...
height $R$ (\S\ref{subsec:hybrid-ran-carrier}); the additive
$\overline\Pi_X$, not the raw quadratic $\Pi_X$, is forced as the
grading by the no-go theorem of Chapter~\ref{ch:k3xe-setup} —
and whose reduced iterated coproduct is
