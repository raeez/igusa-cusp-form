...
constructions of this Pfaffian are at work.  The geometric construction starts from
...
content of Appendix~\ref{app:pfaffian-wall-normal-form} and
Theorem~\ref{thm:G-O2-orbit-transport} of
Appendix~\ref{app:G-O2-discharge}; the present section sketches the
local model only.
