#!/usr/bin/env python3
"""Verify the mixed local/wrapped extension target-admissibility packet."""
...
SUCCESS_STATUS = "MIXED_LOCAL_WRAPPED_ADMISSIBILITY_VERIFIED"
MANIFEST_NAME = "manifest.json"
README_NAME = "README.md"
EXPECTED_SCHEMA = "mixed_local_wrapped_extension_admissibility.v1"
EXPECTED_KIND = "mixed_local_wrapped_extension_admissibility"
...
EXPECTED_EXTENSION_ROWS = {
    "mixed_LW_ext_alpha_eta_zeta_R_I": {
        "R_id": "R",
        "order": "LW",
        "local_colour_id": "alpha_I_to_Gamma_R_loc",
        "wrapped_colour_id": "eta_in_Gamma_R_wr",
        "target_colour_id": "zeta_equals_sum_alpha_plus_eta_in_Gamma_R_wr",
        "extension_stack_id": "E_LW_alpha_eta_zeta_R_I",
        "relative_quot_model_id": "RelQuot_zeta_to_alpha_kernel_eta",
        "exact_sequence_convention": "zero_to_W_eta_to_B_zeta_to_A_alpha_I_to_zero",
    ...
    "mixed_WL_ext_eta_alpha_zeta_R_I": {
        "R_id": "R",
        "order": "WL",
        "local_colour_id": "alpha_I_to_Gamma_R_loc",
        "wrapped_colour_id": "eta_in_Gamma_R_wr",
        "target_colour_id": "zeta_equals_eta_plus_sum_alpha_in_Gamma_R_wr",
        "extension_stack_id": "E_WL_eta_alpha_zeta_R_I",
        "relative_quot_model_id": "RelQuot_zeta_to_eta_kernel_alpha",
        "exact_sequence_convention": "zero_to_A_alpha_I_to_B_zeta_to_W_eta_to_zero",
        "closed_endpoint_conditions": "retained_closed_substacks",
        "extension_closure_source": "retained_extension_closure_rows",
        "finite_type_defect_rank": "0",
        "check_status": "verified",
...
EXPECTED_TARGET_MAP_ROWS = {
    "mixed_LW_maps_alpha_eta_zeta_R": {
        "R_id": "R",
        "order": "LW",
        "extension_stack_id": "E_LW_alpha_eta_zeta_R_I",
        "source_map_formula": "p_LW=(quotient_A_alpha_I,kernel_W_eta)",
        "target_map_formula": "q_LW=B_zeta",
        "quotient_projection": "B_zeta_to_A_alpha_I",
        "kernel_projection": "kernel_W_eta_to_B_zeta",
        "target_map_defect_rank": "0",
        "source_map_defined": "true",
        "source_properness_asserted": "false",
        "check_status": "verified",
    },
    "mixed_WL_maps_eta_alpha_zeta_R": {
        "R_id": "R",
        "order": "WL",
        "extension_stack_id": "E_WL_eta_alpha_zeta_R_I",
        "source_map_formula": "p_WL=(quotient_W_eta,kernel_A_alpha_I)",
        "target_map_formula": "q_WL=B_zeta",
        "quotient_projection": "B_zeta_to_W_eta",
        "kernel_projection": "kernel_A_alpha_I_to_B_zeta",
        "target_map_defect_rank": "0",
        "source_map_defined": "true",
        "source_properness_asserted": "false",
        "check_status": "verified",
...
EXPECTED_ADMISSIBILITY_ROWS = {
    "mixed_LW_q_admissible_alpha_eta_zeta_R": {
        "R_id": "R",
        "order": "LW",
        "extension_stack_id": "E_LW_alpha_eta_zeta_R_I",
        "target_map_id": "q_LW",
    ...
    "mixed_WL_q_admissible_eta_alpha_zeta_R": {
        "R_id": "R",
        "order": "WL",
        "extension_stack_id": "E_WL_eta_alpha_zeta_R_I",
        "target_map_id": "q_WL",
...
EXPECTED_SOURCE_NONPROPER_ROWS = {
    "mixed_LW_p_not_proper_general": {
        "R_id": "R",
        "order": "LW",
        "extension_stack_id": "E_LW_alpha_eta_zeta_R_I",
        "source_map_id": "p_LW",
        "generic_fibre_model": "Ext1(A_alpha_I,W_eta)_mod_Hom",
        "source_properness_asserted": "false",
        "source_properness_defect_rank": "1",
        "check_status": "verified",
    },
    "mixed_WL_p_not_proper_general": {
        "R_id": "R",
        "order": "WL",
        "extension_stack_id": "E_WL_eta_alpha_zeta_R_I",
        "source_map_id": "p_WL",
        "generic_fibre_model": "Ext1(W_eta,A_alpha_I)_mod_Hom",
        "source_properness_asserted": "false",
        "source_properness_defect_rank": "1",
        "check_status": "verified",
    },
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Check mixed local/wrapped extension target-admissibility packet."
    )
    parser.add_argument(
        "--fixture",
        type=Path,
        default=Path("certificates/hybrid/mixed_local_wrapped_extension_admissibility"),
    )
...
def check_manifest(fixture: Path, issues: list[str]) -> None:
    ...
    expected = {
        ...
        "fixture_name": "mixed_local_wrapped_extension_admissibility",
        "hybrid_kind": EXPECTED_KIND,
        "status": SUCCESS_STATUS,
        "mixed_extension_stack_model": True,
        "relative_quot_model": True,
        "target_maps_proper": True,
        "proper_target_pushforward_admissible": True,
        "source_maps_proper": False,
    ...
    if set(manifest.get("tables", [])) != expected_tables:
        issues.append("manifest tables do not match expected mixed admissibility tables")
    expected_imports = {
    ...
    if set(manifest.get("imports", [])) != expected_imports:
        issues.append("manifest imports do not match expected mixed admissibility imports")
...
def main(argv: list[str]) -> int:
    ...
    if issues:
        print("MIXED_LOCAL_WRAPPED_ADMISSIBILITY_FAILED")
        for issue in issues:
            print(f"- {issue}")
        return 1
